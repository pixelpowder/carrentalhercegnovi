...
export async function generateMetadata() {
  return {
    ...
    openGraph: { title: "The Luštica Peninsula Drive — Hidden Beaches Across the Water", description: "Driving and ferrying guide to Luštica: Kamenari ferry, Mirište and Žanjice beaches, Rose village, and the new Luštica Bay.", type: 'website' },
  };
}
