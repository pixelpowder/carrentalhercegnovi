...
export async function generateMetadata() {
  return {
    ...
    alternates: buildAlternates('blog/igalo-thermal-mud-spa'),
    openGraph: { title: "Igalo's Thermal Mud Spa — The Institute Tito Used", description: "Visit guide to Igalo's Institute Dr Simo Milošević: the healing mud, treatment programmes, and the Balkans' biggest rehabilitation spa.", type: 'website' },
  };
}

export default function IgaloThermalMudSpaRoute() {
  const articleSchema = {
