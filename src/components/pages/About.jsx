...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p>We meet every flight at Tivat Airport (TIV) — 40 minutes east via the <a href={localePath('/blog/kamenari-lepetane-ferry')}>Kamenari ferry</a> or around the bay. We can also arrange Dubrovnik Airport pickup for travellers flying into Croatia, with cross-border delivery included. In-town pickups are available at your Herceg Novi or Igalo hotel.</p>
