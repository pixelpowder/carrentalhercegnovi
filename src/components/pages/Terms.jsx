...
export default function Terms() {
  ...
  return (
    ...
    >
      ...
      <p>Budva Car Hire acts as an intermediary and is not liable for:</p>
      <ul>
      ...
      <p>All content on this website, including text, design, and graphics, is owned by Budva Car Hire unless otherwise credited. Stock photography is used under licence from Pexels.</p>

      <h2>Contact</h2>
      <p>Questions about these terms? Contact us at info@budvacarhire.com.</p>
    </ContentPage>
  );
}
